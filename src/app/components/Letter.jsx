...
import { Mail, Heart, Sparkles, RotateCcw, Image as ImageIcon } from "lucide-react"
...
export default function Letter() {
    ...
    const letterText = `My Dear Sweetheart,

"Happiest B'day Madam ji !"

"Janmdin mubarak ho us insaan ko, jise duniya ki sabse khoobsurat 😋 , akalmand aur pyaari cheez mil gayi hai ♥️... yaani ki Main! 🤣 Waise tum bhi theek-thaak hi ho. Khush raho!"

Duniya ki sabse lucky ladki ho tum, kyunki tumhe 'Main' mila hoon. Itni khoobsurat aur smart cheez (yaani main) ko jhelne ke liye tumhe medal milna chahiye, par filhaal is 'Birthday Wish' se kaam chala lo...😝

I hope is saal tumhara dimaag thoda zyada chale aur gussa thoda kam ho. Hamesha aise hi chamakti raho (par makeup pe thoda kam kharcha karna)! Jokes apart, you are my world. Love you hamesha! ❤️✨"
        ...
        >
            <div className="max-w-4xl w-full">
                ...
                >
                    ...
                    <p className="text-md text-pink-300">This was made with love — just for you, Pookie 🥰😘💕</p>
                </motion.div>
