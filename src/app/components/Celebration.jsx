        ...
        const timer = setInterval(() => {
            setCountdown((prev) => {
                if (prev <= 1) {
                    ...
                    setTimeout(() => onMusicStart?.(), 0)
                    
                    // Start confetti when celebration begins
                    const duration = 2500
    ...
    if (!showCelebration) {
        return (
            ...
            >
                ...
                >
                    <motion.h1
                        className="text-6xl md:text-8xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-purple-400 to-indigo-400 mb-8"
                        style={{
